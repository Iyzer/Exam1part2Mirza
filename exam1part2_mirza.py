# -*- coding: utf-8 -*-
"""Exam1Part2-MIRZA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xCT33x1Obi_B29h2WVs7rMI6GB8eGLis
...
sns.regplot(x="stroke", y="price", data=df, color = "grey")
plt.show()
...
plt.pcolor(grouped_pivot, cmap='YlGnBu')
plt.colorbar()
plt.show()
...
fig, ax = plt.subplots()
im = ax.pcolor(grouped_pivot, cmap='YlGnBu')
